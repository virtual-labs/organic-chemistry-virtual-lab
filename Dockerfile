...
# Usage: Installing dependencies for organic-chemistry-virtual-lab
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /organic-chemistry-virtual-lab

COPY src/ /organic-chemistry-virtual-lab/src

WORKDIR ./organic-chemistry-virtual-lab/src
